...
TEST_F(TestCommon, EnsureProcessingStartsAlwaysFromBlock0)
{
    ...
    MEEM_PeriodicTask();                                // This call should trigger processing of block #0
    EXPECT_FALSE(MEEM_GetBlockStatus(0).write_pending); // As soon as block processing starts, its write pending flag will be cleared
