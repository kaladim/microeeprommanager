...
// Field documentation extracted from Python docstrings
const FieldDocs = {
    datamodel: {
    ...
    block: {
        ...
        management_type: "Defines how the block's EEPROM area is managed.",
        instance_count: "Count of instances in the EEPROM. Basic blocks have always 1, backup copy - always 2, multi-profile and wear-leveling blocks have user-defined count in the range [2..15]",
        data_recovery_strategy: "Defines the behaviour during the init phase when block's checksum verification fails.",
        compress_defaults: "Allow reduction of defaults to shortest possible pattern. The reduction is not guaranteed - it depends on the content of default values."
    },
    parameter: {
        name: "Name of the parameter",
        description: "Description of the parameter",
        data_type: "Data type: integer or floating-point",
        multiplicity: "If > 1, defines the parameter as an array",
        default_value: "Default value. Always a list is expected, with number of elements equal to the 'multiplicity'"
    },
    bitfield: {
