...
## Configuration
The only input the *mEEM* needs from you is 2 [JSON](https://en.wikipedia.org/wiki/JSON) files:  
1. An _EEPROM data model_ - a description of your EEPROM data  
2. Platform-specific settings

Then, from your JSONs and the provided [code generator](#tools), you generate several configuration source files.  

## Integration
### 1. Configure & generate:
- The process is covered in details [here](./tools/meem_config_gen/README.md).  

### 2. Implement the required interface:  
- Function bodies of the [EEPROM access interface](src/required_interface/MEEM_EEAIF.h)  
- Function body of the [checksum provider](src/required_interface/MEEM_ChecksumProvider.h)  
- Function bodies of [block initialization callbacks](src/required_interface/MEEM_InitCallbacks.h)  

**A well-written EEPROM access driver and properly chosen checksum algorithm have crucial importance for the proper operation of the *mEEM*!**
