...
On initialization, the user is required to provide an ID of the initially selected profile via [callback](../src/required_interface/MEEM_InitCallbacks.h#24).  
...
Below the **mEEM** are the components, implementing the *required interface*: [MEEM_InitCallbacks.h](../src/required_interface/MEEM_InitCallbacks.h), [MEEM_EEAIF.h](../src/required_interface/MEEM_EEAIF.h), [MEEM_ChecksumProvider.h](../src/required_interface/MEEM_ChecksumProvider.h)  
